---
created: 2026-04-19T08:56:00 (UTC +08:00)
tags: []
source: https://mp.weixin.qq.com/s/xdWnWuwau7lQhR0EQiKTVQ
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/zW6S9vt0cSicIVznEh2XicSg0I5k3awNHlL64t78gHat0QYEQfwJJ2ickD3GHRMsN2DhiaTApibecQ9iaibSBVU3UKJJwfzlNHfWicGq2F7QQBJHmX0/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=0)
...
```
<span leaf=""><span># SOUL.md (Dwight)</span></span>
```
...
```
<span leaf=""><span>#</span><span># Output Files</span></span>
```

Kelly 的 AGENTS.md 告诉她从哪里读：

```
<span leaf=""><span>#</span><span># Intel-Powered Workflow</span></span>
```
...
```
<span leaf=""><span>## Memory</span></span>
```
...
```
<span leaf=""><span># 1. 安装 OpenClaw</span></span>
```
